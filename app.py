...
disciplinas = [{"id": e, "nome": "Empresa "+str(e), "foto":"https://cdn.pixabay.com/photo/2018/01/18/20/42/pencil-3091204_1280.jpg"} for e in range(1,11)]   
...
# Usuários
usuarios = [{"id": e, "nome": "Aluno "+str(e), "senha":"impacta"} for e in range(1,11)]   
